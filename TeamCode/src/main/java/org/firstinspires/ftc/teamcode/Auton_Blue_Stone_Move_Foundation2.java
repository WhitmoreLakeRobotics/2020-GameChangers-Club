...
@Autonomous(name = "Blue_Stone_Foundation2", group = "Auton")
public class Auton_Blue_Stone_Move_Foundation2 extends OpMode {
    ...
    public void init() {
        ...
        RBTChassis.init();
        telemetry.addData("Blue_Stone_Foundation2", "Initialized");
    }
