...
@Autonomous(name = "Auton_drive_Encoder_JJC", group = "Auton")
// @Autonomous(...) is the other common choice

public class Auton_drive_Encoder_JJC extends OpMode {
...
public double TicsTarget = DistanceTarget*TICS_PER_INCH;
    /*
    ...
    public void init() {
        ...
        telemetry.addData("JustThinkCoding", "Initialized");
    ...
    @Override
    public void loop() {
        telemetry.addData("JustThinkCoding", "Running");
